...
public class SelectionOutlineController : MonoBehaviour
{
    ...
    [Range(0, 1)] public float OutlineHardness = 0.85f;
    ...
    void Inital()
    {
        ...
        {
            Debug.LogError(
                "Can't find the outline shaders,please check the Always Included Shaders in Graphics settings.");
            return;
        }
    ...
    public void UpdateTargetRenderer(Renderer renderer)
    {
